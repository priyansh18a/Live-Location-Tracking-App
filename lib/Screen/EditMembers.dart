...
class _EditMembersState extends State<EditMembers> {
  ...
  List <dynamic> _selectedUsernames =  <dynamic>[] ;
  ...
  Future<void> _createGroup() async {
    ...
    try{
      await firestore.collection('groups').doc(_groupId)
          .update(groupsMap);
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Update Unsuccessful! Please try again')));
    }
